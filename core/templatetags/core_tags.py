...
@register.inclusion_tag('core/tags/entries_list.html', takes_context=True)
...
@register.inclusion_tag('core/tags/tags_list.html', takes_context=True)
...
@register.inclusion_tag('core/tags/categories_list.html', takes_context=True)
...
def show_comments(context):
    ...
    if blog_page.display_comments and blog_page.disqus_shortname:
        ...
        return render_to_string('core/comments/disqus.html', context=ctx)
    return ""
...
@register.inclusion_tag('core/tags/post_to_linkedin.html', takes_context=True)
